...
const EC_COUNTRIES = [
  ...
  { code: "BY", name: "Belarus", region: "row" },
  ...
  { code: "KP", name: "Korea, Democratic People's Republic of", region: "row" },
  ...
  { code: "MM", name: "Myanmar", region: "row" },
  ...
  { code: "RU", name: "Russian Federation", region: "row" },
  ...
  { code: "SY", name: "Syrian Arab Republic", region: "row" },
