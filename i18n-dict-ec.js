...
(function () {
  ...
  Object.assign(D.en, {
    ...
    "ec.cmp.menaCallout.eyebrow": "Unique in MENA",
    "ec.cmp.menaCallout.title": "The only digital-first option with a local DFSA licence",
    "ec.cmp.menaCallout.body": "Wise, Revolut and most fintech business accounts don't operate locally with regulated presence in the UAE. Altery MENA — DFSA-licensed in DIFC — offers native AED and USD accounts with neobank-grade UX, alongside Altery Ltd (UK FCA) and Altery EU (Central Bank of Cyprus). Three regulated entities, one login.",
