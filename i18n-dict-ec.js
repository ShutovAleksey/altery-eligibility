...
(function () {
  ...
  Object.assign(D.en, {
    ...
    "ec.cmp.row.multiJurisdiction": "UK + EU + UAE in one product",
    "ec.cmp.v.free": "Free",
    ...
    "ec.cmp.menaCallout.eyebrow": "Altery in the MENA picture",
    "ec.cmp.menaCallout.title": "Published transparent pricing across UK + EU + UAE — at a Starter price point",
    "ec.cmp.menaCallout.body": "Altery MENA is DFSA-licensed in DIFC, alongside Altery Ltd (UK FCA) and Altery EU (Central Bank of Cyprus). 3S Money is the closest peer with its own DIFC presence — but at €100–300/month plus a 3× balance requirement against Altery's £50 Starter. Mashreq and the UAE incumbents bring local AED rails and branches; Altery brings published per-rail FX (0.4–0.8%) and SWIFT (€10–15 + %) the banks don't disclose. Three regulated entities, one login, one tariff page.",
